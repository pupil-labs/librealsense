...
namespace rsimpl
{
    ...
    void ds_device::set_common_ds_config(std::shared_ptr<uvc::device> device, static_device_info& info, const ds::ds_info& cam_info)
    {
        ...
        info.presets[RS_STREAM_COLOR   ][RS_PRESET_BEST_QUALITY] = {true, 640, 480, RS_FORMAT_YUYV, 60, RS_OUTPUT_BUFFER_FORMAT_CONTINUOUS};
        ...
        info.presets[RS_STREAM_COLOR   ][RS_PRESET_LARGEST_IMAGE] = {true, 1920, 1080, RS_FORMAT_YUYV, 30, RS_OUTPUT_BUFFER_FORMAT_CONTINUOUS};
        ...
        info.presets[RS_STREAM_COLOR   ][RS_PRESET_HIGHEST_FRAMERATE] = {true, 640, 480, RS_FORMAT_YUYV, 60, RS_OUTPUT_BUFFER_FORMAT_CONTINUOUS};
